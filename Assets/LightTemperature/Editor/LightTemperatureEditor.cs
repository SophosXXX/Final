...
public class LightTemperatureEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        //Added by RJ to show the cubeRenderer property in the inspector
       // SerializedProperty cubeObject = serializedObject.FindProperty("cubeObject");
        //EditorGUILayout.PropertyField(cubeObject);
    }
